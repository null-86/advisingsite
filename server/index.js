...
app.post('/api/zoomLink/', async (req, res) => {

    try {
        console.log(req.body.cwid, req.body.link);
        let zoomLink = userDB.updateZoom(req.body.cwid, req.body.link);
        res.json(zoomLink);
    }
    catch (e) {
        console.log(e)
...
app.post('/api/retrieveZoomLink/', async (req, res) => {
    try {
        let link = await userDB.getZoomLink(req.body.cwid);
        res.json(link);
    }
    catch (e) {
        console.log(e);
