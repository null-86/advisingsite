    ...
    // const [show, setShow] = useState(false);
     ...
     useEffect(() => {
            let res = {
                ...
                body: JSON.stringify({ cwid: props.studentCwid}) 
              }
                ...
                <Card.Body>
                    <h3 className=" mb-0" >
                        <h5 style={{'font-size': '50%'}}>
                            Class schedule agreements between you and selected advisee for respective semesters. 
                            ...
                            <Accordion.Collapse eventKey="1">
                                <Card.Body>
                                    <Table  responsive striped bordered hover variant="secondary" id={c}>
                                        ...
                                        <tbody style={{ fontSize: "8pt", fontWeight: "20" }}>
