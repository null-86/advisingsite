        ...
        <Container fluid={true} style={{ paddingLeft: 30, paddingRight: 0 }}>
            ...
            <Col className="searchCol" lg={{ size: "auto", span: "auto" }} md={{ size: "auto", span: "auto", order: 1 }}>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Body>Only Advisors are able to undo "uncheck" agreement 
                    <br /> If agreement is already checked, you are undoing the agreement.<br />
                    <span style ={{color: "red", fontSize: "12px"}}> Reload page IMMEDIATELY after attempting to uncheck the agreement</span></Modal.Body>
                    <Modal.Footer>
